...
/// Verifies that matched load maps to north pole.
#[test]
...
/// Verifies that unit magnitude reflection maps to equator.
#[test]
...
/// Verifies that large reflection approaches south pole.
#[test]
...
/// Verifies that negative resistance maps to lower hemisphere.
#[test]
...
/// Verifies that negative matched resistance maps to south pole.
#[test]
