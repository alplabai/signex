...
#[cfg(test)]
#[path = "../../../tests/transmission_line_calculator/component_editor_tests.rs"]
mod tests;

pub(in crate::transmission_line_calculator::tool) const DEFAULT_S_PARAMETER_TEXT: &str =
    "# MHz S MA R 50\n1000 0.1 0 2.0 0 0.02 0 0.1 180";

impl CircuitEditorComponent {
    /// Creates a component editor row populated with defaults for `kind`.
    ...
    /// Updates field with the supplied value.
    ...
    /// Converts this value to element.
...
/// Builds the component editor user-interface section.
    ...
    section(
        ...
        vec![
            row![
                ...
                checkbox_row(
                    "Ideal components (ignore parasitics)",
                    state.show_ideal,
...
/// Builds the component editor card.
fn component_card(
    index: usize,
...
/// Builds the component input control.
