use crate::transmission_line_calculator::{
    Complex, FrequencyPointResult, GainCircle, NoiseFigureCircle, ScalarUnit, SmithViewTransform,
    StabilityCircle,
};

use super::{ImpedanceArcTrace, SParameterTrace};

/// Supplies solved traces, overlays, labels, and display flags to the 2D canvas.
#[derive(Debug, Clone)]
