...
/// Standard schematic grid step: 2.54 mm = 100 mils. Used as pin length,
/// bus-entry size, and any other default that snaps to the coarse grid.
pub const GRID_MM: f64 = 2.54;

/// Standard default pin line length in mm (one grid step).
pub const PIN_LENGTH_MM: f64 = GRID_MM;

/// Standard default offset from pin body-end to pin name text anchor.
pub const PIN_NAME_OFFSET_MM: f64 = 0.508;

// ---------------------------------------------------------------------------
// Point -- Standard mm-space coordinate (f64). Copy-friendly.
// ---------------------------------------------------------------------------
