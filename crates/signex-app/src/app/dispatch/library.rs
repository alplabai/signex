...
use crate::library::messages::{
    BrowserEditMsg, CloseLibraryChoice, EditorMsg, LibraryMessage, PickerMsg, PrimitiveEditorMsg,
    PrimitivePickerMsg, SettingsMsg,
};
...
// The primitive-editor reducers (symbol, footprint) and the
// Component-Preview inline-edit reducer live in their own modules now
// (issue #98); re-imported so the dispatcher call sites are unchanged.
use crate::library::editor::footprint::apply::{
...
use crate::library::inline_edit::apply_inline_edit;
