...
pub(super) const ACTIVE_BAR: &[CommandMetadata] = &[
    ...
    CommandMetadata {
        ...
        menu_label: Some("Move Selection by X, Y..."),
        group: CommandGroup::Schematic,
        enable: Enablement::RequiresSelection,
        flags: CommandFlags::GUI_MUTATES,
        ..CommandMetadata::DEFAULT
    ...
    CommandMetadata {
        ...
        menu_label: Some("Drag Selection"),
        group: CommandGroup::Schematic,
        enable: Enablement::RequiresSelection,
        flags: CommandFlags::GUI_MUTATES,
        ..CommandMetadata::DEFAULT
    ...
    CommandMetadata {
        ...
        menu_label: Some("Rotate Selection"),
        group: CommandGroup::Schematic,
        enable: Enablement::RequiresSelection,
        flags: CommandFlags::MUTATES,
        ..CommandMetadata::DEFAULT
    ...
    CommandMetadata {
        ...
        menu_label: Some("Rotate Selection Clockwise"),
        group: CommandGroup::Schematic,
        enable: Enablement::RequiresSelection,
        flags: CommandFlags::MUTATES,
        ..CommandMetadata::DEFAULT
    ...
    CommandMetadata {
        ...
        menu_label: Some("Flip Selected Sheet Symbols Along X"),
        group: CommandGroup::Schematic,
        enable: Enablement::RequiresSelection,
        flags: CommandFlags::MUTATES,
        ..CommandMetadata::DEFAULT
    ...
    CommandMetadata {
        ...
        menu_label: Some("Flip Selected Sheet Symbols Along Y"),
        group: CommandGroup::Schematic,
        enable: Enablement::RequiresSelection,
        flags: CommandFlags::MUTATES,
        ..CommandMetadata::DEFAULT
    ...
    CommandMetadata {
        ...
        menu_label: Some("Bring To Front"),
        group: CommandGroup::Schematic,
        enable: Enablement::RequiresSelection,
        flags: CommandFlags::MUTATES,
        ..CommandMetadata::DEFAULT
    ...
    CommandMetadata {
        ...
        menu_label: Some("Bring To Front Of"),
        group: CommandGroup::Schematic,
        enable: Enablement::RequiresSelection,
        flags: CommandFlags::MUTATES,
        ..CommandMetadata::DEFAULT
    ...
    CommandMetadata {
        ...
        menu_label: Some("Send To Back Of"),
        group: CommandGroup::Schematic,
        enable: Enablement::RequiresSelection,
        flags: CommandFlags::MUTATES,
        ..CommandMetadata::DEFAULT
    ...
    CommandMetadata {
        ...
        menu_label: Some("Device Sheet Symbol"),
        group: CommandGroup::Schematic,
        enable: Enablement::RequiresDocument(DocumentKind::Schematic),
        flags: CommandFlags::GUI_MUTATES,
        ..CommandMetadata::DEFAULT
    ...
    CommandMetadata {
        ...
        menu_label: Some("Align Horizontal Centers"),
        group: CommandGroup::Schematic,
        enable: Enablement::RequiresSelection,
        flags: CommandFlags::MUTATES,
        ..CommandMetadata::DEFAULT
    ...
    CommandMetadata {
        ...
        menu_label: Some("Distribute Horizontally"),
        group: CommandGroup::Schematic,
        enable: Enablement::RequiresSelection,
        flags: CommandFlags::MUTATES,
        ..CommandMetadata::DEFAULT
    ...
    CommandMetadata {
        ...
        menu_label: Some("Align Vertical Centers"),
        group: CommandGroup::Schematic,
        enable: Enablement::RequiresSelection,
        flags: CommandFlags::MUTATES,
        ..CommandMetadata::DEFAULT
    ...
    CommandMetadata {
        ...
        menu_label: Some("Distribute Vertically"),
        group: CommandGroup::Schematic,
        enable: Enablement::RequiresSelection,
        flags: CommandFlags::MUTATES,
        ..CommandMetadata::DEFAULT
    ...
    CommandMetadata {
        ...
        menu_label: Some("Signal Harness"),
        group: CommandGroup::Schematic,
        enable: Enablement::RequiresDocument(DocumentKind::Schematic),
        flags: CommandFlags::GUI_MUTATES,
        ..CommandMetadata::DEFAULT
    ...
    CommandMetadata {
        ...
        menu_label: Some("Harness Connector"),
        group: CommandGroup::Schematic,
        enable: Enablement::RequiresDocument(DocumentKind::Schematic),
        flags: CommandFlags::GUI_MUTATES,
        ..CommandMetadata::DEFAULT
    ...
    CommandMetadata {
        ...
        menu_label: Some("Off Sheet Connector"),
        group: CommandGroup::Schematic,
        enable: Enablement::RequiresDocument(DocumentKind::Schematic),
        flags: CommandFlags::GUI_MUTATES,
        ..CommandMetadata::DEFAULT
    ...
    CommandMetadata {
        ...
        menu_label: Some("Differential Pair"),
        group: CommandGroup::Schematic,
        enable: Enablement::RequiresDocument(DocumentKind::Schematic),
        flags: CommandFlags::GUI_MUTATES,
        ..CommandMetadata::DEFAULT
    ...
    CommandMetadata {
        ...
        menu_label: Some("Elliptical Arc"),
        group: CommandGroup::Schematic,
        enable: Enablement::RequiresDocument(DocumentKind::Schematic),
        flags: CommandFlags::GUI_MUTATES,
        ..CommandMetadata::DEFAULT
    ...
    CommandMetadata {
        ...
        menu_label: Some("Round Rectangle"),
        group: CommandGroup::Schematic,
        enable: Enablement::RequiresDocument(DocumentKind::Schematic),
        flags: CommandFlags::GUI_MUTATES,
        ..CommandMetadata::DEFAULT
    ...
    CommandMetadata {
        ...
        menu_label: Some("Clear Net Color"),
        group: CommandGroup::Schematic,
        enable: Enablement::RequiresDocument(DocumentKind::Schematic),
    ...
    CommandMetadata {
        ...
        menu_label: Some("Clear All Net Colors"),
        group: CommandGroup::Schematic,
        enable: Enablement::RequiresDocument(DocumentKind::Schematic),
        flags: CommandFlags::NONE,
        ..CommandMetadata::DEFAULT
