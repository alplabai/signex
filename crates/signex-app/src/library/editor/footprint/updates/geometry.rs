...
pub(super) fn apply(editor: &mut crate::app::FootprintEditorState, msg: FootprintEditorMsg) {
    match msg {
        FootprintEditorMsg::AddNewSibling => add_new_sibling(editor),
        FootprintEditorMsg::AddPad { x_mm, y_mm } => add_pad(editor, x_mm, y_mm),
        FootprintEditorMsg::AddVia { x_mm, y_mm } => add_via(editor, x_mm, y_mm),
        FootprintEditorMsg::TrackClick { x_mm, y_mm } => track_click(editor, x_mm, y_mm),
        FootprintEditorMsg::TrackCancel => track_cancel(editor),
        FootprintEditorMsg::ArcClick { x_mm, y_mm } => arc_click(editor, x_mm, y_mm),
        FootprintEditorMsg::ArcCancel => arc_cancel(editor),
        FootprintEditorMsg::PolygonClick { x_mm, y_mm } => polygon_click(editor, x_mm, y_mm),
        FootprintEditorMsg::PolygonCommit => polygon_commit(editor),
        FootprintEditorMsg::PolygonCancel => polygon_cancel(editor),
        FootprintEditorMsg::AddText { x_mm, y_mm } => add_text(editor, x_mm, y_mm),
        FootprintEditorMsg::AddTextFrame {
            x_mm,
            y_mm,
            w_mm,
            h_mm,
        } => add_text_frame(editor, x_mm, y_mm, w_mm, h_mm),
        FootprintEditorMsg::AddHole { x_mm, y_mm } => add_hole(editor, x_mm, y_mm),
        FootprintEditorMsg::MintBody3d => mint_body3d(editor),
        FootprintEditorMsg::MintExtrudedBody3d => mint_extruded_body3d(editor),
...
fn add_via(editor: &mut crate::app::FootprintEditorState, x_mm: f64, y_mm: f64) {
...
fn track_cancel(editor: &mut crate::app::FootprintEditorState) {
...
fn arc_cancel(editor: &mut crate::app::FootprintEditorState) {
...
fn polygon_commit(editor: &mut crate::app::FootprintEditorState) {
...
fn polygon_cancel(editor: &mut crate::app::FootprintEditorState) {
