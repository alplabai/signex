...
//! snapped-or-minted click Point, the raw coords, the sticky construction /
//! centerline flags) and dispatches to the per-tool sub-modules. Preamble
//! bodies moved verbatim from the former monolith.
