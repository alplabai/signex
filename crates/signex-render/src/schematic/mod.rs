...
/// coordinates from `.standard_sch` and should be rendered directly.
...
///
/// Mirrors Standard's `SCH_FIELD::GetDrawRotation()`:
...
pub(super) fn field_effective_style(
    ...
    let draw = if y1_nonzero {
        // Standard toggles: 0° ↔ 90° when symbol is rotated 90°/270°.
